...
TEST_CASE("BlurFilter applies filter to the image") {
    ...
    std::vector<std::vector<double>> expected_values = {
        {0.784314, 0.784314, 0.784314, 0.784314},  // NOLINT
        {0.784314, 0.784314, 0.784314, 0.784314},  // NOLINT
        {0.784314, 0.784314, 0.784314, 0.784314},  // NOLINT
        {0.784314, 0.784314, 0.784314, 0.784314},  // NOLINT
    };
    ...
    for (int32_t i = 0; i < height; ++i) {
        for (int32_t j = 0; j < width; ++j) {
            ...
            REQUIRE(actual_value == Approx(expected_value).epsilon(0.1));  // NOLINT
        }
    }
}
